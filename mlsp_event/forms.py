...
from mlsp_event.models import EventPost
from mezzanine.core.models import CONTENT_STATUS_DRAFT


# These fields need to be in the form, hidden, with default values,
# since it posts to the event post admin, which includes these fields
...
class EventPostForm(forms.ModelForm):
    """
    Model form for ``EventPost`` that provides the quick event panel in the
    admin dashboard.
    """
