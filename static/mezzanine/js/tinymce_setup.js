...
if (typeof tinyMCE != 'undefined') {
    ...
    tinyMCE.init({
        ...
        theme_advanced_buttons1: "justifyleft,justifycenter,justifyright,justifyfull,|,bold,italic,|,link,unlink,|,image,|,media,charmap,|,code,|,table,|,bullist,numlist,outdent,indent,blockquote,|,undo,redo,|,formatselect,|,search,replace,|,fullscreen,",
